...
<template>
  ...
  <footer>
    ...
    Votre liste de flux est mémorisée sur cet appareil (localStorage) et vous sera proposée à chaque visite.<br />
    <router-link to="/mentions-legales" class="lien-mentions">Mentions légales</router-link>
  </footer>
</template>
